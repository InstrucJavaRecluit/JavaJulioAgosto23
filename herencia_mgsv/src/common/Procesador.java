...
public class Procesador {
	...
	public void renderizar() {
		System.out.println("Renderizando con nucleos logicos ....");
	}
	
	
	
// anivel de metodo el operador final impide a sobre escritura..
	//a nivel de clase bloquea la herencia el operador final 
}
